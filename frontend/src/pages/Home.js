          ...
          <div className="info-grid">
            <div className="info-card card reveal">
              ...
              <div className="hours-table">
                <div className="hour-row"><span>Mon – Thu</span><span>10:00 AM – 9:00 PM</span></div>
                <div className="hour-row"><span>Friday</span><span>2:00 PM – 9:00 PM</span></div>
                <div className="hour-row"><span>Saturday</span><span>10:00 AM – 10:00 PM</span></div>
                <div className="hour-row"><span>Sunday</span><span>10:00 AM – 9:00 PM</span></div>
              </div>
            </div>
            <div className="info-card card reveal">
              <h3>📍 Find Us</h3>
