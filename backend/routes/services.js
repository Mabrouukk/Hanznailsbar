...
const services = [
  {
    ...
    items: [
      ...
      { name: "Treatment without color", price: 550, duration: "30 mins", description: "Premium pedicure experience" },
      { name: "manicure VIP", price: 500, duration: "30 mins", description: "Premium VIP pedicure experience" },
      { name: "manicure", price: 250, duration: "30 mins", description: "Premium VIP manicure experience" },
